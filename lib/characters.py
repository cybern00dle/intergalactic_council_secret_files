...
* Вы получили Конспект по цифровой грамотности.'''
        ...
        self.trigger_death = '3'
        self.neutral_end = '* Cтудент пялится на Вас. Вы начинаете сомневаться в своей экспертизе касательно жестовых языков.'
...
class Sergeant_Peepers(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = 'А, ты опять. Ничего не знаешь, но активно делаешь вид, что заслужила повышение, чтобы мешать провинуться по карьерной лестнице тем, кто *кхм-кхм* действительно этого заслуживает.'
...
4. Знаю, но не скажу.'''
        ...
        self.have_we_met_before = 0
        self.level = 4
        self.artefact = 'папочка с компорматом (лучше у Вас, чем у Сержанта Пиперса)'

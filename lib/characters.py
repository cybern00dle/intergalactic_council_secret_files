...
Чуть-чуть покапавшись, вы находите модель принтера и пересобираете его. 
...
Преподавательница садится на пол и много думает. Похоже, лингвистам всё-таки придётся лишний час подождать контрольных.'''
        self.trigger_bad_end = '1' 
        self.death = '''На что вы расчитывали? Преподавательнице сейчас не до шуток, у её лингвистов оценки не проставлены, а они сидят сейчас на паре без препода и чаи гоняют.
Вы умираете.'''
        self.trigger_death = '3'

...
У вас остаётся две лишние детали - одна бесформенна и бесполезна,
однако вторая по форме напоминает перо. И на ощупь как перо. И на вкус - самое настоящее воронье перо. Только светится.'''
        self.trigger_good_end = '2'
        self.bad_end = '''Вы достаёте из Бездонного Хранилища звуковую отвёртку, направляете её на принтер и цвет индикатора резко сменяется на зелёный.

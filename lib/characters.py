...
class Captain(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = '''Приветствую, разведчик! Надеюсь, ты готова к своей первой операции по поддержанию равновесия в Мультивселенной? Конечно, готова! 
Вот твое первое задание: на Земле, в точке твоего прибытия зарегистрирована паранормальная деятельность. Информанты докладывают о некоем "Культе Белой Вороны". 
Твоя задача - проникнуть в университет, на котором базируется культ и собрать о нем как можно больше информации, с вещественными доказательствами. 
Твоя деятельность прокладывает дорогу для отдела зачистки.'''
...
class Strange_group(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = '''Вот и ты.
* Это было сказано тихо. Скорее всего, группа девушек не надеялась, что Вы это услышите.
* Последовала пауза, во время которой четыре пары глаз разглядывали Вас настолько внимательно, словно видели Ваш настоящий облик сквозь маскировку.'''

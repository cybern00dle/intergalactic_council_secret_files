...
class Captain(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = 'Капитан Кондраки: Приветствую, разведчик! Надеюсь, ты готова к своей первой операции по поддержанию равновесия в Мультивселенной? Конечно, готова! Вот твое первое задание...'
        self.goodbye = 'Капитан Кондраки: Не хочу сгущать краски, но от твоего успеха напрямую зависит существование всех разумных форм жизни! Удачи, разведчик!'
        ...
        self.death = 'Капитан Кондраки: ...Бедняга. (Капитан смотрит на Вас с некой жалостью. Он приближается к вам, вытягивая в Вашем направлении руки, но, вопреки Вашим надеждам, это не объятие. Капитан пожалел Вас достаточно, чтобы быстро свернуть Вам шею, и Вы почти не чувствуете боли перед наступлением вечной темноты. Вы мертвы.)'
        self.trigger_death = '3'
        self.neutral_end = 'Капитан Кондраки: Да-да, конечно, удачи. (Капитан быстро теряет в Вас интерес и исчезает)'
...
class Emo_Janitor(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = 'Эмо-уборщик: Жизнь тлен.'
        self.goodbye = 'Эмо-уборщик: Жизнь все равно тлен.'
        self.good_end = 'Эмо-уборщик: Мейнстрим. Но многие и такого не знают. На, заслужил'
        ...
        self.death = 'Эмо-уборщик: Мда. (Эмо-уборщик, не меняясь в лице, проворачивает швабру в руках и пронзает Вас насквозь. Вы мертвы).'
...
class The_Lost_Student(Character):
    def __init__(self):
        ...
        self.trigger_bad_end = '2'
        self.death = '(Вы, довольная собой, идете дальше и поскальзываетесь на банановой кожуре.Вы не успеваете подумать о том, карма ли это. Вы мертвы)'
        self.trigger_death = '3'
        ...
        self.question = '''Неправильный у вас институт, ни одного микроскопа нет.
                        1. Ты уверен, что то настоящий язык жестов?
                        2. (пригрозить) Сейчас вызову Сержанта Пиперса, он разберется,
                        'что это у нас за шпион.
...
class Sergeant_Peepers(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = 'Сержант Пиперс: А, ты опять. Ничего не знаешь, но активно делаешь вид, что заслужила повышение, чтобы мешать провинуться по карьерной лестнице тем, кто *кхм-кхм) действительно этого заслуживает'
        self.goodbye = '(Высокомерно и не прощаясь, Сержант уходит. Вы надеетесь, что на борту скоро появится психолог)'
        self.good_end = 'Сержант Пиперс: Чистая удача! Ты не можешь знать этого сама! (злится и убегает, роняя красную папочку в жесткой обложке)'
        self.trigger_good_end = '1'
        ...
        self.trigger_bad_end = '2'
        self.death = 'Сержант Пиперс: Ты меня запугивать вздумала? (Сержант побелел от ярости) Чтож... Не жить тебе, самозванка. (он нападает на вас и сильно ударяет в висок. Вы мертвы.) '
        self.trigger_death = '3'
        ...
        self.have_we_met_before = 0
        self.level = 4
        self.artefact = 'папочка с компорматом. Лучше у Вас, чем у него.'
...
class Safety_Belt(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = 'Ремень безопасности: Пристегни меня!'
        ...
        self.trigger_bad_end = '2'
        self.death = '(Не спросив себя о том, почему ремень безопасности разговаривает, а Бога - о том, как Вы дожили до сегодняшнего дня, Вы ожидаемо узнаете, что ремень безопасности - хищный мимик. Вы мертвы.)'
        self.trigger_death = '3'
...
class The_lost_child(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = 'Ребёнок: Привет!'
        self.goodbye = 'Ребёнок: Пока'
...
class Predatory_plant(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = 'Цветок: Эй! Да не туда смотри, левее, левее. Ага, в горшке.'
        self.goodbye = ''
        self.good_end = '''Цветок: О-о-о, вода со вкусом воды, спасибо! Не уходи, у меня есть подарок 
...
Вы решаете взять его. '''
        self.goodbye = 'Пирог: Всё-таки приятно быть выбранным'
...
class The_clone(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = 'Злой клон Лосяша: Нефеноменально.'
        self.goodbye = 'Злой клон Лосяша: И всё же нефеноменально.'
...
Изображение абстрактной композиции из шумов и полосок на стене начинает мигать, то темнея, то бледнея, как вдруг появляется огромный знак вопроса, а затем фотография аппетитной котлеты с картофельным пюре'''
        ...
        self.trigger_good_end = '3'
        self.bad_end = '''Проектор показывает эмодзи-череп, после чего падает, ломая пополам стоящую под ним парту. Вы напуганы, но живы.'''
        self.trigger_bad_end = '1'
...
3. *попытаться связаться с помощью телекинеза*
...
class FGN_student(Character):
    def __init__(self):
        ...
        self.picture = ''
        self.hello = '''Студентка ФГН: Хей!
Девушка, сидящая на скамейке, машет вам рукой.'''
        self.goodbye = 'До связи!'
        self.good_end = '''Девушка многозначительно улыбается.
